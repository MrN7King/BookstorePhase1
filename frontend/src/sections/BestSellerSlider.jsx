    ...
    <div key={book._id} className="scroll-snap-align-center flex-shrink-0 w-36 sm:w-40 md:w-44 lg:w-52">
      <Cards
                ...
                <button
                    ...
                    className="absolute right-0 lg:right-4 z-30 p-4 rounded-full bg-white border border-gray-200 shadow-md text-gray-700 hover:text-blue-600 hover:bg-gray-50 transition-all duration-300 transform hover:translate-x-1 hover:scale-110 opacity-0 group-hover:opacity-100 hidden sm:block"
