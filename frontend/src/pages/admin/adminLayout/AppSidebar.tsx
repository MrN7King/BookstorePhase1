...
const navItems: NavItem[] = [
  {
    iconName: "dashboard", // Google Fonts icon name
    name: "Dashboard",
    path: "/admin",
  },
  {
      ...
      {items.map((nav, index) => (
        <li key={nav.name}>
          {nav.subItems ? (
            ...
            >
              <span
                className={`material-symbols-outlined menu-item-icon-size ${
                  openSubmenu?.type === menuType && openSubmenu?.index === index
              ...
              {(isExpanded || isHovered || isMobileOpen) && (
                <span
                  className={`ml-auto w-5 h-5 transition-transform duration-200 material-symbols-outlined ${
                ...
                >
                  expand_more {/* Google Fonts icon for ChevronDown */}
                </span>
              )}
            </button>
          ) : (
            ...
            <div>
              ...
              >
                {isExpanded || isHovered || isMobileOpen ? (
                  ...
                  <span className="material-symbols-outlined size-6">more_horiz</span> // Google Fonts icon for horizontal dots
                )}
              </h2>
